      ...
      {isVoiceOpen && createPortal(
        <div className="voice-search-modal-overlay" role="presentation" onMouseDown={closeVoiceSearch}>
          ...
          >
            <button
              type="button"
              className="voice-search-close"
              onClick={closeVoiceSearch}
              aria-label={t("header.closeVoiceSearch")}
            >
              <X size={22} />
            </button>
            <div className="voice-search-modal-icon"><Waves size={24} /></div>
            <h2 id="voice-search-title">
              {isListening ? t("header.voiceSearchListening") : t("header.voiceSearchDone")}
            </h2>
            ...
            <div className="voice-search-transcript">
              {voiceText || t("header.voiceSearchSpeakNow")}
            </div>
            <button
              type="button"
              className={`voice-search-mic ${isListening ? "is-listening" : ""}`}
              onClick={isListening ? stopListening : startVoiceSearch}
            >
