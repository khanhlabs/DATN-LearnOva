...
export const deleteSupportConversationNotificationsApi = async (conversationId, client = axiosClient) => {
  const response = await client.delete(`/notifications/support/${conversationId}`);
  return response.data;
};
