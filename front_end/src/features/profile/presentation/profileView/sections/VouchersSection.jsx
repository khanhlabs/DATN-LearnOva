        ...
        {isLoading ? (
            ...
            <div className="vouchers-grid">
              {pageVouchers.map((voucher) => {
                const isClaimed = voucher.status === "claimed";
                return (
                    <article className={`voucher-card voucher-card-${voucher.voucherId} voucher-tone-${voucher.tone} ${isClaimed ? "is-claimed" : ""}`} key={voucher.voucherId}>
