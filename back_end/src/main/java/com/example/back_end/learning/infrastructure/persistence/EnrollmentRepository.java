...
public interface EnrollmentRepository extends JpaRepository<Enrollment, EnrollmentId> {
    ...
    List<com.example.back_end.auth.domain.User> findDistinctStudentsByInstructorId(@Param("instructorId") Long instructorId);

    @Query("SELECT DISTINCT e.user FROM Enrollment e WHERE e.course.id = :courseId")
    List<com.example.back_end.auth.domain.User> findDistinctStudentsByCourseId(@Param("courseId") Long courseId);
