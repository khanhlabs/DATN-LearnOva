...
import com.example.back_end.assessment.adapter.in.web.dto.AnswerResponse;
import com.example.back_end.assessment.adapter.in.web.dto.LessonQAResponse;
import com.example.back_end.assessment.adapter.in.web.dto.LikeResponse;
import com.example.back_end.assessment.adapter.in.web.dto.QuestionResponse;
import com.example.back_end.commerce.infrastructure.persistence.LessonQALikeRepository;
import com.example.back_end.entity.LessonQALike;
import com.example.back_end.course.domain.Course;
import com.example.back_end.course.domain.Lesson;
import com.example.back_end.assessment.domain.LessonQA;
...
public class LessonQAService {
    ...
    @Transactional
    public LikeResponse toggleLike(Long userId, Long qaId) {
